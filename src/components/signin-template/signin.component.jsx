...
function Copyright(props) {
    return (
        <Typography variant="body2" color="text.secondary" align="center" {...props}>
            {'Copyright © '}
            <Link color="inherit" href="https://milo.lac2.io/">
                LAC2 - MILO
            </Link>{' '}
...
export default function SignInSide() {
    ...
    return (
        <ThemeProvider theme={theme}>
            <Grid container component="main" sx={{ height: '80vh', width: '80%', margin: '0 0 0 150px' }}>
                <CssBaseline />
                <Grid
                    item
                    xs={false}
                    ...
                    md={7}
                    sx={{
                        backgroundImage: 'url(https://source.unsplash.com/random/?nature,mountain)',
